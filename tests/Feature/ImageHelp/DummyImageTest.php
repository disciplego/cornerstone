...
it('returns a customizable dummy image', function () {
    expect(ImageHelp::getDummyImageUrl())->toEqual('https://dummyimage.com/600x400/000/fff.png&text=Image+Text')
        ->and(ImageHelp::getDummyImageUrl(format: 'jpg'))->toEqual('https://dummyimage.com/600x400/000/fff.jpg&text=Image+Text');
});

it('returns a dummy image with custom dimensions', function () {
    expect(ImageHelp::getDummyImageUrl(width: '800', height: '600'))
        ->toEqual('https://dummyimage.com/800x600/000/fff.png&text=Image+Text');
});

it('returns a dummy image with custom colors', function () {
    expect(ImageHelp::getDummyImageUrl(backgroundColor: '123', fontColor: '456'))
        ->toEqual('https://dummyimage.com/600x400/123/456.png&text=Image+Text');
});
